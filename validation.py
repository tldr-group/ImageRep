...
for j, p in enumerate(projects):
    ...
    if img.any():
        ...
        pred_err_vf, _, tpc = util.make_error_prediction(img[0, :l, :l].cpu(), model_error=False, correction=False)
        pred_err_sa, _, tpc = util.make_error_prediction(sa_img[0, :l, :l].cpu(), model_error=False, correction=False)
